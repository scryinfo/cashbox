...
void main() {
  group('ClientTransportChannel', () {
    ...
    var refresh = RefreshOpen.get(new ConnectParameter("localhost", serverRefreshPort), "", AppPlatformType.any, "", "", "", 000);
    bool odd = true;
    ...
    var callException = () async {
      ...
      expect(null, channel.connectParameter); //由于调用失败所以，connectParameter is null
    };
