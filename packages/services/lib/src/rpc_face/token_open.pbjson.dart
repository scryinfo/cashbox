...
const EthTokenOpen_Token$json = const {
  ...
  '2': const [
    ...
    const {'1': 'GasPrice', '3': 8, '4': 1, '5': 3, '10': 'GasPrice'},
...
const EeeTokenOpen$json = const {
  '1': 'EeeTokenOpen',
  '3': const [EeeTokenOpen_Token$json, EeeTokenOpen_QueryReq$json, EeeTokenOpen_QueryRes$json],
};

const EeeTokenOpen_Token$json = const {
  '1': 'Token',
  '2': const [
    const {'1': 'Id', '3': 1, '4': 1, '5': 9, '10': 'Id'},
    const {'1': 'TokenShardId', '3': 2, '4': 1, '5': 9, '10': 'TokenShardId'},
...
const EeeTokenOpen_QueryReq$json = const {
  '1': 'QueryReq',
  '2': const [
    const {'1': 'info', '3': 1, '4': 1, '5': 11, '6': '.rpc_face.BasicClientReq', '10': 'info'},
    const {'1': 'isDefault', '3': 2, '4': 1, '5': 8, '10': 'isDefault'},
...
const EeeTokenOpen_QueryRes$json = const {
  '1': 'QueryRes',
  '2': const [
    const {'1': 'tokens', '3': 1, '4': 3, '5': 11, '6': '.rpc_face.EeeTokenOpen.Token', '10': 'tokens'},
    const {'1': 'page', '3': 2, '4': 1, '5': 11, '6': '.rpc_face.PageRes', '10': 'page'},
    const {'1': 'err', '3': 3, '4': 1, '5': 11, '6': '.rpc_face.Err', '10': 'err'},
  ],
};
