...
const CashboxVersion$json = const {
  '1': 'CashboxVersion',
  '3': const [
    CashboxVersion_Model$json,
    CashboxVersion_SaveReq$json,
    CashboxVersion_SaveRes$json,
    CashboxVersion_GetByIdRes$json,
    CashboxVersion_QueryReq$json,
    CashboxVersion_QueryRes$json
  ],
};
