...
class Refresh_ServiceMeta extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      const $core.bool.fromEnvironment('protobuf.omit_message_names')
          ? ''
          : 'Refresh.ServiceMeta', package: const $pb.PackageName(
      const $core.bool.fromEnvironment('protobuf.omit_message_names')
          ? ''
    ...
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names')
        ? ''
        : 'host')
    ..aInt64(6, const $core.bool.fromEnvironment('protobuf.omit_field_names')
        ? ''
        : 'port')
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names')
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'serviceStatus', protoName: 'serviceStatus')..aOS(9,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'remark')
  ...
  factory Refresh_ServiceMeta.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()
        ..mergeFromBuffer(i, r);

  factory Refresh_ServiceMeta.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()
        ..mergeFromJson(i, r);
  ...
  @$core.Deprecated(
      'Using this can add significant overhead to your binary. '
          ...
          'Will be removed in next major version')
  Refresh_ServiceMeta copyWith(void Function(Refresh_ServiceMeta) updates) =>
      super.copyWith((message) => updates(
          message as Refresh_ServiceMeta)); // ignore: deprecated_member_use
  ...
  static $pb.PbList<Refresh_ServiceMeta> createRepeated() =>
      $pb.PbList<Refresh_ServiceMeta>();

  @$core.pragma('dart2js:noInline')
  static Refresh_ServiceMeta getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<Refresh_ServiceMeta>(create);
  ...
  @$pb.TagNumber(8)
  set serviceStatus($core.String v) {
    $_setString(7, v);
  }
...
class Refresh_RefreshReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      const $core.bool.fromEnvironment('protobuf.omit_message_names')
          ? ''
          : 'Refresh.RefreshReq', package: const $pb.PackageName(
      const $core.bool.fromEnvironment('protobuf.omit_message_names')
          ? ''
          : 'rpc_face'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names')
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'appPlatformType', protoName: 'appPlatformType')..aOS(3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'sign')
    ..hasRequiredFields = false
  ...
  factory Refresh_RefreshReq.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()
        ..mergeFromBuffer(i, r);

  factory Refresh_RefreshReq.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()
        ..mergeFromJson(i, r);
  ...
  @$core.Deprecated(
      'Using this can add significant overhead to your binary. '
          'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
          'Will be removed in next major version')
  Refresh_RefreshReq copyWith(void Function(Refresh_RefreshReq) updates) =>
      super.copyWith((message) => updates(
          message as Refresh_RefreshReq)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  ...
  static $pb.PbList<Refresh_RefreshReq> createRepeated() =>
      $pb.PbList<Refresh_RefreshReq>();

  @$core.pragma('dart2js:noInline')
  static Refresh_RefreshReq getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<Refresh_RefreshReq>(create);
...
class Refresh_RefreshRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      const $core.bool.fromEnvironment('protobuf.omit_message_names')
          ? ''
          : 'Refresh.RefreshRes', package: const $pb.PackageName(
      const $core.bool.fromEnvironment('protobuf.omit_message_names')
          ? ''
          : 'rpc_face'), createEmptyInstance: create)
    ..aOM<$1.Err>(1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'err', subBuilder: $1.Err.create)..aOM<Refresh_ServiceMeta>(2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'serviceMeta', protoName: 'serviceMeta',
        subBuilder: Refresh_ServiceMeta.create)
    ..hasRequiredFields = false
  ;
  ...
  factory Refresh_RefreshRes.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()
        ..mergeFromBuffer(i, r);

  factory Refresh_RefreshRes.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()
        ..mergeFromJson(i, r);
  ...
  @$core.Deprecated(
      'Using this can add significant overhead to your binary. '
          'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
          'Will be removed in next major version')
  Refresh_RefreshRes copyWith(void Function(Refresh_RefreshRes) updates) =>
      super.copyWith((message) => updates(
          message as Refresh_RefreshRes)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  ...
  static $pb.PbList<Refresh_RefreshRes> createRepeated() =>
      $pb.PbList<Refresh_RefreshRes>();

  @$core.pragma('dart2js:noInline')
  static Refresh_RefreshRes getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<Refresh_RefreshRes>(create);
  ...
  @$pb.TagNumber(2)
  set serviceMeta(Refresh_ServiceMeta v) {
    setField(2, v);
  }
...
class Refresh extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      const $core.bool.fromEnvironment('protobuf.omit_message_names')
          ? ''
          : 'Refresh', package: const $pb.PackageName(
      const $core.bool.fromEnvironment('protobuf.omit_message_names')
          ? ''
          : 'rpc_face'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ...
  Refresh copyWith(void Function(Refresh) updates) =>
      super.copyWith((message) =>
          updates(message as Refresh)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
