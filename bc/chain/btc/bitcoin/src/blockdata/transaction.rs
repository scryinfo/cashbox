...
use consensus::{Decodable, Encodable, encode, serialize};
...
mod tests {
    ...
    #[test]
    fn test_deserialization_tx() {
        let hex_tx = hex_bytes("").unwrap();
        let tx: Result<Transaction, _> = deserialize(&hex_tx);
        assert!(tx.is_ok());
        println!("{:#?}", tx.unwrap());
    }
