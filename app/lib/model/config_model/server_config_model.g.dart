...
ServerConfigModel _$ServerConfigModelFromJson(Map<String, dynamic> json) => ServerConfigModel()
...
Data _$DataFromJson(Map<String, dynamic> json) =>
    Data()..latestConfig = LatestConfig.fromJson(json['latestConfig'] as Map<String, dynamic>);
...
LatestConfig _$LatestConfigFromJson(Map<String, dynamic> json) => LatestConfig()
  ...
  ..authTokenUrl = (json['authTokenUrl'] as List<dynamic>).map((e) => e as String).toList()
  ..defaultTokenUrl = (json['defaultTokenUrl'] as List<dynamic>).map((e) => e as String).toList()
