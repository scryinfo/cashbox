...
import 'package:app/global_config/scry_global_config.dart';
...
const etherscanApiKey = ScryGlobalConfig.ETHERSCAN_API_KEY; //todo change it 替换成你自己,在etherscan中申请的apikey
