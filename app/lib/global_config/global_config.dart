...
//http://api-cn.etherscan.com/api?module=account&action=txlist&address=0xa4512ca7618d8d12a30C28979153aB09809ED7fD&startblock=0&endblock=999999&page=1&offset=20&sort=asc&apikey=XGB9RHEF6XKHIB37G5S33CWFK89XQJ5EU1
String assembleEthTxListUrl(String address,{String contractAddress,String netType=Eth_Tx_List,String startBlock = "0",String endBlock="99999999",String page="1",String offset="20"}) {
  print("url==>"+netType + address + "&startblock="+startBlock+"&endblock="+endBlock+"&page="+page+"&offset="+offset+"&sort=desc&apikey=" + ETHERSCAN_API_KEY);
  return netType + address + "&startblock="+startBlock+"&endblock="+endBlock+"&page="+page+"&offset="+offset+"&sort=desc&apikey=" + ETHERSCAN_API_KEY;
}
