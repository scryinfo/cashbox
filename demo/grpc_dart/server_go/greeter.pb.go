...
var file_greeter_proto_rawDesc = []byte{
	...
	0x09, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x5f, 0x67, 0x6f, 0x22, 0x22, 0x0a, 0x0c, 0x48, 0x65,
	...
	0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x5f, 0x67, 0x6f, 0x2e, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x15, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x5f,
	0x67, 0x6f, 0x2e, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x62,
...
var file_greeter_proto_goTypes = []interface{}{
	(*HelloRequest)(nil), // 0: server_go.HelloRequest
	(*HelloReply)(nil),   // 1: server_go.HelloReply
}
var file_greeter_proto_depIdxs = []int32{
	0, // 0: server_go.Greeter.SayHello:input_type -> server_go.HelloRequest
	1, // 1: server_go.Greeter.SayHello:output_type -> server_go.HelloReply
...
func (c *greeterClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/server_go.Greeter/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Greeter_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/server_go.Greeter/SayHello",
	}
