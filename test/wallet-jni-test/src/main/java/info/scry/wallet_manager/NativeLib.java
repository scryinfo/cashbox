...
public class NativeLib {
    ...
    public static class Wallet {
        ...
        public String toString() {
            return "Wallet{" +
                    ...
                    ", ethChain=" + ethChain +
                    ", btcChain=" + btcChain +
                    ", nowChainId='" + nowChainId + '\'' +
                    ", isNowWallet=" + isNowWallet +
    ...
    //msg: transaction
    // TODO: 2019/8/17 The transaction method is to be determined, to be determined: which side to monitor the transaction status. At present, the chain transfer module does not support the filling of notes. If it needs to support the note function in the future, the transfer module will be rewritten.
    //  Add a new interface that will not affect the use of old versions of APP增加新的接口，不会影响老版本APP的使用
     ...
     *
     * @param encodeData Enter the data in hexadecimal format  ‘0x’
